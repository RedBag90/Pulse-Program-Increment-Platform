...
Pulse tatsächlich verwendet: Kachel, Ballot, Verteilung, Ergebnis.
...
`Rahmen · Ballot · Beteiligte & Gruppen · Runde starten · Verteilen ·
...
- **Runde starten** friert den Ballot ein und nimmt die aktiven
...
prüft nur, dass die Kachel im Entwurf ist. Dass ein Ballot und eine besetzte
...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Portfolio Manager**          | `budget.round.manage` — Kachel anlegen, Rahmen setzen, Ballot kuratieren, Gruppen bilden, starten. Dieselbe Rolle trägt auch `budget.manage`.                                                                             |
...
Sprechern und der Ballot. Beides ist vorausgewählt; wer zum zweiten Mal
...
**2 · Ballot.** Was zur Wahl steht. Ich wähle Epics aus dem budgeting-reifen
...
noch nicht darf: ohne Kandidaten auf dem Ballot und ohne eine besetzte Gruppe
gibt es nichts zu verteilen. Drücke ich ihn, friert der Ballot ein, die
...
Start jeder Runde automatisch auf den Ballot.
...
| Ballot               | mindestens ein Kandidat                       | —                                      |
| Beteiligte & Gruppen | mindestens eine Gruppe mit einem Mitglied     | —                                      |
| Runde starten        | die Kachel läuft                              | Ballot leer oder keine besetzte Gruppe |
