...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | --------------- |
| Hero (Fakten/Ökonomie/Reifegrad/Next-Step), Overview, Business Case, Benefit-Hypothese, „Reifegrad-Timeline", Deliverables (Feature-Liste/Doku + ART-Zuordnung)                                                              | Work       | ✅ funktioniert |
