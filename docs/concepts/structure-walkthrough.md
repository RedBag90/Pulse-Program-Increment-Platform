...
Dies ist **kein** „gelebter Prozess" wie die drei Schwesterdokumente — und das
ist Absicht. [Epic](epic-lifecycle-walkthrough.md),
[Budget](budgeting-walkthrough.md) und [PI](pi-walkthrough.md) erzählen
Abläufe: etwas beginnt, wandert durch Zustände, endet. Die Struktur wandert
nicht. Sie ist der Rahmen, in dem die drei stattfinden — Wertströme, ARTs,
...
| **Betrieb**    | Was kostet der laufende Betrieb, und wie groß sind die Veränderungsrahmen der ARTs?                    |
...
Fläche, für die der ganze ART-Topf gebaut wurde: hier sieht ein RTE seine Last,
...
Er ist keine Beschriftung. Zwei Dinge hängen daran:
...
Der zweite Punkt ist der Grund für den ersten: Verantwortung ohne
...
**Zum Budget.** Der Veränderungsrahmen entsteht im Betrieb-Reiter des Wertstroms
als Run-the-Business-Position und wird über den Ballot festgeschrieben; verteilt
...
| Veränderungsrahmen und Zuteilung                 | `src/modules/budgeting/server/services/art-pot.ts`                       |
