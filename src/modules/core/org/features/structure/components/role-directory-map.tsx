...
import { isHorizon } from "@/modules/core/org/domain/horizon";
import {
  Lane,
  LaneGroup,
  type LaneColumn,
  ...
  return (
    <>
      <div className="flex items-baseline gap-2">
        ...
        {/* Rechts steht, was diese Spalte über ihr Thema sagt — drüben die Zahl
            der PIs, hier die Zahl der unbesetzten Plätze in ihr. */}
        {offen > 0 && (
