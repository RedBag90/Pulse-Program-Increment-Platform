...
const dto = (over: Partial<EpicEconomicsDTO> = {}): EpicEconomicsDTO => ({
  ...
  // **Abgenommen zum Achsenstart.** Nutzen zählt erst ab L4.2; ohne Stempel
  // zeigen diese Tests über die Nutzen-Mechanik nichts mehr, weil dann nur
  // Zukunftsmonate zählen. Das Kostenfenster bleibt Jan–Dez 2026.
        ...
        benefitKpis: [
          {
            ...
            measurements: [{ date: "2025-12-15", value: 100 }],
          },
        ],
      }),
    ]);
