...
vi.mock("@/modules/work/features/portfolio/components/lpm-review/benefit-waterfall", () => ({
  BenefitWaterfall: () => <div data-testid="waterfall" />,
}));
vi.mock("@/modules/work/features/portfolio/components/lpm-review/benefit-burnup", () => ({
  BenefitBurnup: () => <div data-testid="burnup" />,
}));
vi.mock("@/modules/work/features/portfolio/components/lpm-review/portfolio-bubble-matrix", () => ({
  PortfolioBubbleMatrix: () => <div data-testid="matrix" />,
}));
vi.mock("@/modules/work/features/portfolio/components/lpm-review/diverging-schedule-bar", () => ({
